...
// Tools > RoboSim > Robot > Mechanisms > Build Pneumatic. Save to the PREFAB afterward.
public class PneumaticBuilderWindow : EditorWindow
{
    private const string Title = "Build Pneumatic";
    ...
    [MenuItem("Tools/RoboSim/Robot/Mechanisms/Build Pneumatic", false, 23)]
